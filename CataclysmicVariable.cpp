...
CataclysmicVariable::CataclysmicVariable() : primary(""), secondary(""), distance(0),
...
CataclysmicVariable::CataclysmicVariable(std::string primary, std::string secondary, double distance,
...
double CataclysmicVariable::getBarycenter(double distance, double primaryMass, double secondaryMass) const
{
